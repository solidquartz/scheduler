...
describe("Application", () => {
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    await waitForElement(() => getByText(container, "Error: Could not save"));
    expect(getByText(appointment, /Error: Could not save/i)).toBeInTheDocument();
  ...
  it("shows the save error when failing to delete an appointment", async () => {
    ...
    await waitForElement(() => getByText(container, "Error: Could not delete"));
    expect(getByText(appointment, /Error: Could not delete/i)).toBeInTheDocument();
